 ...
 * @Description:外部文件多路归并排序
 * 参考文章：https://juejin.cn/post/6844903762621005837
 */
public class DiskMergeSort implements Closeable {
    ...
    public static List<String> generateFiles(int n, int minEntries, int maxEntries) {
        ...
        for (int i = 0; i < n; i++) {
            String filename = "/tmp/input-" + i + ".txt";
            PrintWriter writer;
            try {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 运行多次看算法耗时
        for (int i = 0; i < 20; i++) {
            DiskMergeSort sorter = new DiskMergeSort(inputs, "/tmp/output.txt");
